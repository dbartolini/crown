...
* Tools: adding components to a unit will now open a searchable list organized into component categories.
...
* Runtime: sun shadow cascades now blend smoothly across their overlap regions.
...
* Tools: the Project Browser now handles the Enter key correctly.
...
* Tools: Windows: fixed warnings when opening external URIs or some resource types.
...
* Tools: fixed object trees inside editors unnecessarily expand when modified.
