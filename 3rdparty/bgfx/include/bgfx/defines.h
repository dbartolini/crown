...
#define BGFX_TEXTURE_EXPORT                       UINT64_C(0x0001000000000000) //!< Texture will be used for exporting.
...
#define BGFX_CAPS_TEXTURE_EXPORT                  UINT64_C(0x0000000100000000) //!< Exporting textures is supported.
